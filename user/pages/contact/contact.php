    ...
    <div class="bostami-page-content-wrap">
        ...
        <div class="section-wrapper pr-60 pl-60 mb-60">
            <div class="contact-area bg-light-white-2">
                <h5 class="contact-title">Saya selalu terbuka untuk Berdiskusi</h5>
                <form class="contact-form" action="https://formspree.io/f/xblrbkje" method="post">
                    <div class="form-input-item mb-60">
                        <label class="input-lebel name">Nama *</label>
                    ...
                    <div class="form-input-item mb-40">
                        <label class="input-lebel message">Pesan *</label>
                        <textarea name="message" class="input-box message" cols="30"
                            rows="10"></textarea>
                    </div>
                    <div class="form-btn-wrap">
                        <button type="submit" value="Send" class="form-btn">kirim</button>
                    </div>
                </form>
            </div>
        </div>
